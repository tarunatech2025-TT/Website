...
export default function Navbar() {
  ...
  return (
    <>
      {/* ── Announcement bar ── */}
      <div className="relative z-50 bg-gradient-to-r from-[#1a0030]/80 via-[#0d0020]/70 to-[#1a0030]/80 border-b border-pink-500/10 py-2 px-4 text-center text-xs text-purple-300/70 backdrop-blur-sm">
        <span className="inline-flex items-center gap-2 flex-wrap justify-center">
          <Zap size={10} className="text-pink-400 flex-shrink-0" />
          Best IT Company in Vadodara — IT Consultancy Available
          <Link href="/contact" className="underline underline-offset-2 hover:text-pink-300 transition-colors font-semibold">
            Contact Us
          </Link>
        </span>
      </div>
